(function (global, factory) {
  ...
  */
    ...
    methods: {
      ...
      handleAssignClick: function handleAssignClick() {
        ...
        postData(
          ...
          ( obj = {}, obj[this.csrfHeaderName] = this.csrfValue, obj )
        )
  ...
  var postData = function (url, body, headers) {
    if ( url === void 0 ) url = '';
    if ( body === void 0 ) body = {};
