(function (global, factory) {
  ...
  (global = global || self, factory((global.mailery = global.mailery || {}, global.mailery.rbac = {})));
  ...
  */
  ...
  var script$2 = {
    ...
    methods: {
      ...
      handleAvailableChecked: function handleAvailableChecked(node) {
        node.states.checked ? this.availableChecked++ : this.availableChecked--;
      },
      handleSelectedChecked: function handleSelectedChecked(node) {
        node.states.checked ? this.selectedChecked++ : this.selectedChecked--;
      },
      handleAssignClick: function handleAssignClick() {
        console.log('handleAssignClick');
      },
    ...
    return _c("div", { staticClass: "row" }, [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.treeFilterAvailable,
                  expression: "treeFilterAvailable"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", placeholder: "Type to filter..." },
              domProps: { value: _vm.treeFilterAvailable },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.treeFilterAvailable = $event.target.value;
                }
              }
            })
          ]),
            ...
            [
              _c("tree", {
                ...
                attrs: {
                  data: _vm.items,
                  options: _vm.options,
                  filter: _vm.treeFilterAvailable
                },
                on: {
                  "node:checked": _vm.handleAvailableChecked,
                  "node:unchecked": _vm.handleAvailableChecked
                }
              })
            ],
            1
      ...
      _c("div", { staticClass: "col-2 col-2 mt-auto mb-auto text-center" }, [
        _c(
          "button",
          {
            class: _vm.buttonCssClasses(_vm.availableChecked),
        ...
        _c(
          "button",
          {
            class: _vm.buttonCssClasses(_vm.selectedChecked),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.treeFilterSelected,
                  expression: "treeFilterSelected"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", placeholder: "Type to filter..." },
              domProps: { value: _vm.treeFilterSelected },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.treeFilterSelected = $event.target.value;
                }
              }
            })
          ]),
            ...
            [
              _c("tree", {
                ...
                attrs: {
                  data: _vm.items,
                  options: _vm.options,
                  filter: _vm.treeFilterSelected,
                  z: ""
                },
                on: {
                  "node:checked": _vm.handleSelectedChecked,
                  "node:unchecked": _vm.handleSelectedChecked
                }
              })
            ],
            1
  ...
  __vue_render__$3._withStripped = true;
    ...
    var __vue_inject_styles__$4 = function (inject) {
      if (!inject) { return }
      inject("data-v-24635ae1_0", { source: "\n.treeview-wrapper[data-v-24635ae1] {\n  height: 300px;\n  overflow-y: scroll;\n}\n", map: {"version":3,"sources":["/home/filsh/www/mailery/node_modules/@maileryio/mailery-rbac-assets/src/components/DualTreeview.vue"],"names":[],"mappings":";AAsGA;EACA,aAAA;EACA,kBAAA;AACA","file":"DualTreeview.vue","sourcesContent":["<template>\n  <div class=\"row\">\n    <div class=\"col-5\">\n      <div class=\"border\">\n        <div class=\"m-2\">\n          <input class=\"form-control\" type=\"text\" placeholder=\"Type to filter...\" v-model=\"treeFilterAvailable\">\n        </div>\n        <div class=\"border-bottom mb-2\"></div>\n        <div class=\"treeview-wrapper m-2\">\n          <tree\n            ref=\"availableTree\"\n            class=\"tree--small\"\n            :data=\"items\"\n            :options=\"options\"\n            :filter=\"treeFilterAvailable\"\n            @node:checked=\"handleAvailableChecked\"\n            @node:unchecked=\"handleAvailableChecked\" />\n          </div>\n        </div>\n    </div>\n\n    <div class=\"col-2 col-2 mt-auto mb-auto text-center\">\n      <button v-bind:class=\"buttonCssClasses(availableChecked)\" v-on:click=\"handleAssignClick\">\n        <slot name=\"assign-button-content\"></slot>\n      </button>\n      <div class=\"mb-3\"></div>\n      <button v-bind:class=\"buttonCssClasses(selectedChecked)\" v-on:click=\"handleUnassignClick\">\n        <slot name=\"unassign-button-content\"></slot>\n      </button>\n    </div>\n\n    <div class=\"col-5\">\n      <div class=\"border\">\n        <div class=\"m-2\">\n          <input class=\"form-control\" type=\"text\" placeholder=\"Type to filter...\" v-model=\"treeFilterSelected\">\n        </div>\n        <div class=\"border-bottom mb-2\"></div>\n        <div class=\"treeview-wrapper m-2\">\n          <tree\n            ref=\"selectedTree\"\n            class=\"tree--small\"\n            :data=\"items\"\n            :options=\"options\"\n            :filter=\"treeFilterSelected\"z\n            @node:checked=\"handleSelectedChecked\"\n            @node:unchecked=\"handleSelectedChecked\" />\n          </div>\n        </div>\n    </div>\n  </div>\n</template>\n\n<script>\n  import LiquorTree from 'liquor-tree';\n\n  export default {\n    name: 'ui-dual-treeview',\n    components: { LiquorTree },\n    data: () => ({\n      items: [\n        {text: 'Item 1'},\n        {text: 'Item 2'},\n        {text: 'Item 3', state: { expanded: true }, children: [\n          {text: 'Item 3.1'},\n          {text: 'Item 3.2'}\n        ]}\n      ],\n      options: {\n        checkbox: true,\n        checkOnSelect: true\n      },\n      treeFilterAvailable: '',\n      treeFilterSelected: '',\n      availableChecked: 0,\n      selectedChecked: 0,\n    }),\n    methods: {\n      buttonCssClasses(counter) {\n        return {\n          'btn': 'btn',\n          'disabled': counter === 0,\n          'btn-secondary': counter === 0,\n          'btn-primary': counter > 0\n        }\n      },\n      handleAvailableChecked(node) {\n        node.states.checked ? this.availableChecked++ : this.availableChecked--;\n      },\n      handleSelectedChecked(node) {\n        node.states.checked ? this.selectedChecked++ : this.selectedChecked--;\n      },\n      handleAssignClick() {\n        console.log('handleAssignClick');\n      },\n      handleUnassignClick() {\n        console.log('handleUnassignClick');\n      }\n    }\n  }\n</script>\n\n<style scoped>\n  .treeview-wrapper {\n    height: 300px;\n    overflow-y: scroll;\n  }\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$4 = "data-v-24635ae1";
    /* module identifier */
