  ...
  var script$2 = {
    ...
    methods: {
      ...
      handleAssignClick: function handleAssignClick() {
        var selection = this.$refs.unassignedTree.findAll({ state: { checked: true } });
