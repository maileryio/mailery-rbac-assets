(function (global, factory) {
  ...
  */
  ...
  var script$2 = {
    ...
    methods: {
      ...
      handleAssignClick: function handleAssignClick() {
        ...
        postData(
          this.postAssignUrl,
          Object.assign({}, getSelectedData(this.$refs.unassignedTree),
            ( obj = {}, obj[this.csrfName] = this.csrfValue, obj ))
        )
      ...
      handleUnassignClick: function handleUnassignClick() {
        ...
        postData(
          ...
          Object.assign({}, getSelectedData(this.$refs.assignedTree),
            ( obj = {}, obj[this.csrfName] = this.csrfValue, obj ))
        )
          .then(function (response) { return response.json(); })
          .then(function (response) {
  ...
  var __vue_render__$4 = function () {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _c("div", { staticClass: "typehead" }, [
      _vm.type === "checkbox"
        ? _c("input", {
            directives: [
              {
            ...
            staticClass: "form-control",
            attrs: { name: _vm.name, autocomplete: "off", type: "checkbox" },
            domProps: {
        ...
        ? _c("input", {
            ...
            staticClass: "form-control",
            attrs: { name: _vm.name, autocomplete: "off", type: "radio" },
        ...
        : _c("input", {
            ...
            staticClass: "form-control",
            attrs: { name: _vm.name, autocomplete: "off", type: _vm.type },
  ...
  __vue_render__$4._withStripped = true;
    ...
    var __vue_inject_styles__$5 = function (inject) {
      if (!inject) { return }
      inject("data-v-2cf5e170_0", { source: ".typehead[data-v-2cf5e170] {\n  padding: 0;\n  border: none;\n  position: relative;\n}\n.typehead ul[data-v-2cf5e170] {\n  width: 100%;\n  max-height: 350px;\n  overflow-y: auto;\n  margin-top: 0.125rem 0 0;\n  position: absolute;\n  z-index: 999;\n  box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);\n  border-radius: 5px;\n  border: 1px solid #ced4da;\n}\n.typehead ul > li[data-v-2cf5e170] {\n  background-color: #fff;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.125);\n  display: block;\n  padding: 0.25rem 1rem;\n  position: relative;\n  cursor: pointer;\n}\n.typehead ul > li[data-v-2cf5e170]:last-child {\n  border: none;\n}\n.typehead ul > li.active[data-v-2cf5e170], .typehead ul > li[data-v-2cf5e170]:hover {\n  color: #fff;\n  background-color: #007bff;\n}\n\n/*# sourceMappingURL=Typeahead.vue.map */", map: {"version":3,"sources":["/home/filsh/www/mailery/node_modules/@maileryio/mailery-rbac-assets/src/components/Typeahead.vue","Typeahead.vue"],"names":[],"mappings":"AAqHA;EACA,UAAA;EACA,YAAA;EACA,kBAAA;ACpHA;ADsHA;EACA,WAAA;EACA,iBAAA;EACA,gBAAA;EACA,wBAAA;EACA,kBAAA;EACA,YAAA;EACA,6CAAA;EACA,kBAAA;EACA,yBAAA;ACpHA;ADsHA;EACA,sBAAA;EACA,6CAAA;EACA,cAAA;EACA,qBAAA;EACA,kBAAA;EACA,eAAA;ACpHA;ADsHA;EACA,YAAA;ACpHA;ADuHA;EAEA,WAAA;EACA,yBAAA;ACtHA;;AAEA,wCAAwC","file":"Typeahead.vue","sourcesContent":["<template>\n  <div class=\"typehead\">\n    <input\n      :type=\"type\"\n      :name=\"name\"\n      v-model=\"query\"\n      autocomplete=\"off\"\n      class=\"form-control\"\n      @keydown.down=\"down\"\n      @keydown.up=\"up\"\n      @keydown.enter.stop.prevent=\"hit\"\n      @keydown.esc=\"reset\"\n      @blur=\"reset\"\n      @input=\"update\"\n    />\n\n    <ul v-show=\"hasItems\" class=\"list-unstyled\">\n      <li v-for=\"(item, $item) in items\" :class=\"activeClass($item)\" @mousedown=\"hit\" @mousemove=\"setActive($item)\">\n        <span v-text=\"item.text\"></span>\n      </li>\n    </ul>\n  </div>\n</template>\n\n<script>\n  export default {\n    name: 'ui-typeahead',\n    props: {\n      url: 'String',\n      type: 'String',\n      name: 'String',\n      value: 'String'\n    },\n    data () {\n      return {\n        items: [],\n        query: this.value,\n        current: -1,\n        loading: false,\n        limit: 5,\n        minChars: 1,\n      }\n    },\n    computed: {\n      hasItems () {\n        return this.items.length > 0\n      }\n    },\n\n    methods: {\n      update () {\n        if (!this.query) {\n          return this.reset();\n        }\n\n        if (this.minChars && this.query.length < this.minChars) {\n          return;\n        }\n\n        this.loading = true;\n\n        this.fetch()\n          .then(response => response.json())\n          .then((response) => {\n            if (response && this.query) {\n              this.items = this.limit ? response.slice(0, this.limit) : response;\n              this.current = -1;\n              this.loading = false;\n            }\n          });\n      },\n      fetch () {\n        let url = this.url;\n        url += (url.indexOf('?') === -1 ? '?' : '&') + 'q=' + encodeURIComponent(this.query);\n\n        return fetch(url);\n      },\n      hit (e) {\n        if (this.current !== -1) {\n          this.value = this.items[this.current].text;\n          this.reset();\n        }\n      },\n      reset () {\n        this.items = [];\n        this.query = this.value;\n        this.loading = false;\n      },\n      down () {\n        if (this.current < this.items.length - 1) {\n          this.current++;\n        } else {\n          this.current = -1;\n        }\n      },\n      up () {\n        if (this.current > 0) {\n          this.current--;\n        } else if (this.current === -1) {\n          this.current = this.items.length - 1;\n        } else {\n          this.current = -1;\n        }\n      },\n      setActive (index) {\n        this.current = index\n      },\n      activeClass (index) {\n        return {\n          active: this.current === index\n        }\n      }\n    }\n  }\n</script>\n\n<style scoped lang=\"scss\">\n  .typehead {\n    padding: 0;\n    border: none;\n    position: relative;\n\n    ul {\n      width: 100%;\n      max-height: 350px;\n      overflow-y: auto;\n      margin-top: .125rem 0 0;\n      position: absolute;\n      z-index: 999;\n      box-shadow: 0 .5rem 1rem rgba(0,0,0,.15);\n      border-radius: 5px;\n      border: 1px solid #ced4da;\n\n      &>li {\n        background-color: #fff;\n        border-bottom: 1px solid rgba(0,0,0,.125);\n        display: block;\n        padding: .25rem 1rem;\n        position: relative;\n        cursor: pointer;\n\n        &:last-child {\n          border: none;\n        }\n\n        &.active,\n        &:hover {\n          color: #fff;\n          background-color: #007bff;\n        }\n      }\n    }\n  }\n</style>\n",".typehead {\n  padding: 0;\n  border: none;\n  position: relative;\n}\n.typehead ul {\n  width: 100%;\n  max-height: 350px;\n  overflow-y: auto;\n  margin-top: 0.125rem 0 0;\n  position: absolute;\n  z-index: 999;\n  box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);\n  border-radius: 5px;\n  border: 1px solid #ced4da;\n}\n.typehead ul > li {\n  background-color: #fff;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.125);\n  display: block;\n  padding: 0.25rem 1rem;\n  position: relative;\n  cursor: pointer;\n}\n.typehead ul > li:last-child {\n  border: none;\n}\n.typehead ul > li.active, .typehead ul > li:hover {\n  color: #fff;\n  background-color: #007bff;\n}\n\n/*# sourceMappingURL=Typeahead.vue.map */"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$5 = "data-v-2cf5e170";
    /* module identifier */
